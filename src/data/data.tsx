...
export const highlightsData = [
  {
    icon: 'FaHammers', // Replace with appropriate icon or image
    title: 'Stonework Experts',
    description:
      'We specialize in stonework, brickwork, and blockwork, delivering stunning results every time.',
  },
  {
    icon: 'FaBuilding', // Replace with appropriate icon or image
    title: 'Residential & Commercial',
    description:
      'We serve both residential and commercial clients, providing high-quality craftsmanship for every project.',
  },
  {
    icon: 'FaHandsHelping', // Replace with appropriate icon or image
    title: 'Free Quotation',
    description:
      'We offer free estimates to all customers, ensuring transparency and affordability.',
  },
...
export const whyChooseUs = [
  {
    ...
    description:
      'Our team of experts has years of experience in stonework and masonry, ensuring top-quality craftsmanship.',
  },
  {
    title: 'Quality Materials',
    description:
      'We use only the finest materials in our projects, ensuring durability and a beautiful finish.',
  },
  {
    title: 'Client Satisfaction',
    description:
      'Our primary goal is the satisfaction of our clients. We work closely with you to bring your vision to life.',
  },
  {
    title: 'Competitive Pricing',
    description:
      'We offer competitive pricing without compromising on the quality of our work. Get the best value for your investment.',
  },
];
